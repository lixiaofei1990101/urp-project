...
<body>
	<div id="tt" class="easyui-tabs" style="width: 100%; height: 100%;" >
		<div title="机构列表" style="display: none;">
			<table id="menutreegrid" class="easyui-treegrid" style="height: 100%" data-options="
				...
				collapsible: true,
				fitColumns: true,
				url: 'office/officeAction!queryListOffice.action',
				method: 'get',
				idField: 'id',
				treeField: 'name'">
			<thead>
				<tr>
					<th data-options="field:'name',width:150,align:'left'">机构名称</th>
					<th data-options="field:'areaName',width:100">归属地区</th>
					<th data-options="field:'code',width:80">机构编码</th>
					<th data-options="field:'type',width:30,align:'center'">机构类型</th>
					<th data-options="field:'remarks',width:80,align:'center'">备注</th>
